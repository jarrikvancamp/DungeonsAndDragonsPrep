...
**Effect:** Touch a willing creature and roll a d4. The creature can add the number rolled to one ability check of its choice. The spell ends when the die is rolled or the spell ends.

**Tactical Use:**
- Use before important skill checks
- Help with lockpicking, investigation, persuasion
- No resource cost - use liberally
- Great for helping party members succeed
...
**Effect:** Create one of the following effects:
- Create a tiny, harmless sensory effect that predicts weather for next 24 hours
- Instantly make a flower blossom, seed pod open, or leaf bud bloom
- Create an instantaneous, harmless sensory effect (falling leaves, puff of wind, faint animal sounds)
- Instantly light or snuff out a candle, torch, or small campfire

**Tactical Use:**
- Distraction during stealth (animal sounds, wind)
- Light sources for exploration
- Weather prediction for travel planning
- Social/roleplay utility
...
- Outlined in colored light (no invisibility)
...
**Effect:** Summon fey spirits in beast form. Choose one:
...
### Combat Priority
1. **Round 1:** Faerie Fire or Entangle for battlefield control
...
### Resource Management
- **Cantrips:** Use liberally - no cost
